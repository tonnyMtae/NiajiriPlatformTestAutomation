...
public class CVPreviewTest extends Base {
    ...
    @Test(description = "Niajiri Inside CV Upload > Verify Filling Valid Referees Details", retryAnalyzer = RetryListener.class)
    public void verifyCVPreviewFunctionality() throws InterruptedException {
        loadPropertiesFile();
        ...
        refereesPage.reviewReferees();

        WaitUtils.sleepTime(5);

        CVPreviewPage cvPreviewPage = new CVPreviewPage(driver);
        cvPreviewPage.selectTemplateAndContinue();
    }
